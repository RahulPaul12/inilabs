  ...
  return (
    <div className="container text-center relative">
      <div className="">
        ...
        <h1 className="font-bold text-base lg:text-5xl margin-auto leading-[56px]">
      ...
      <div className="mt-8">
        ...
        {/* button section */}
        <button className="w-full lg:w-[280px] h-auto lg:h-[48px] outline outline-1 outline-[#4262FF] text-[#4262FF] py-3 lg:px-9  rounded-3xl">
      ...
      <div className="grid-cols-1 sm:grid md:grid-cols-3 mt-14 text-[#05003899]">
        ...
        {/* first customer */}
        <div className="px-9 mt-6 flex flex-col rounded-lg  text-left w-full lg:w-[360px] h-auto lg:h-[460px]">
          <img className="w-full h-auto" src={img1} alt="" />
          <div className="mb-4 py-7 pe-7 w-full lg:w-72">
        ...
        <div className="px-9 mt-6 flex flex-col rounded-lg  text-left w-full lg:w-[360px] h-auto lg:h-[460px]">
          ...
          <div className="mt-auto flex items-center pb-9">
            ...
            <div className="mx-4 flex flex-col font-normal text-sm">
              <small>Jane Ashley</small>
              <small>Head of Design at DocuSign</small>
            </div>
          </div>
        </div>
        ...
        <div className="px-9 mt-6 flex flex-col rounded-lg  text-left w-full lg:w-[360px] h-auto lg:h-[460px]">
          ...
          <div className="mt-auto flex items-center pb-9">
            ...
            <div className="mx-4 flex flex-col font-normal text-sm">
              <small>Laura Baird</small>
              <small>Associate Design Director at frog</small>
            </div>
          </div>
        </div>
      </div>
